      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Join active relief efforts and make a difference in your community. 
            Select an effort below to register as a volunteer.
          </p>
        </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <Button
                        asChild
                        className="w-full"
                        onClick={() => router.push(`/efforts/${effort.slug}/volunteer`)}
                      >
                        <Link href={`/efforts/${effort.slug}/volunteer`}>
                          Join as Volunteer
